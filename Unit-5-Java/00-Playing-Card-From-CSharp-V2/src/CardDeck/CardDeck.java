...
public class CardDeck
{
	...
	public PlayingCard dealCard()
	{
		if (deckOfCards.size() > 0)
		{
			...
			deckOfCards.remove(	0); //Remove 1st element - C# .Remove
			return cardToDeal;
		}
		else
		{
	...
	public int removeJokers()
	{
		...
		jokerCards.add(new PlayingCard(PlayingCard.PlayingCard));// Remember # cards before removal
